...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', default="ALE", help='Type of environment: ALE or GYM. Default = ALE', dest="env")
    ...
    parser.add_argument('-lra', '--lr_annealing_steps', default=80000000, type=int, help="Nr. of global steps during which the learning rate will be linearly annealed towards zero. Default = 80*10^6", dest="lr_annealing_steps")
    ...
    parser.add_argument('-n', '--num_actor_learners', default=16, type=int, help="number of actors (processes). Default = 16", dest="num_actor_learners")
    ...
    parser.add_argument('--max_global_steps', default=80000000, type=int, help="Max. number of training steps. Default = 80*10^6", dest="max_global_steps")
